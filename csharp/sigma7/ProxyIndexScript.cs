...
public class ProxyIndexScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.position = MidPoint.transform.position + (UnityHaptics.DoubleToVect(Index) - UnityHaptics.GetToolPosition());
    }
}
